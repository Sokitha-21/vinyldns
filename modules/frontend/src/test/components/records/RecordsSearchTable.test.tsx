...
describe("<RecordsSearchTable />", () => {
  it("renders the empty state when no records are provided", () => {
    renderWithProviders(<RecordsSearchTable records={[]} />);
    expect(screen.getByText("No records found")).toBeInTheDocument();
  });

  it("renders the table headers in the default configuration", () => {
    renderWithProviders(<RecordsSearchTable records={[recordRow()]} />);
  ...
  it("omits the ZONE column when showZone=false", () => {
    renderWithProviders(
      <RecordsSearchTable records={[recordRow()]} showZone={false} />,
    );
  ...
  it("renders a Shared access badge when zoneShared=true", () => {
    renderWithProviders(
      <RecordsSearchTable records={[recordRow({ zoneShared: true })]} />,
    );
  ...
  it("renders a Private access badge when zoneShared=false", () => {
    renderWithProviders(
      <RecordsSearchTable records={[recordRow({ zoneShared: false })]} />,
    );
